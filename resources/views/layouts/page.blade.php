...
<script src="{{asset('m/js/jquery-1.11.1.min.js')}}"></script>
	...
	<div class="about" id="welcome">
		<div class="container">
			...
			<input type="hidden" id="v_data" value="{{json_encode($place)}}">
    			...
    			navigator.geolocation.getCurrentPosition(function(p){
			    	...
			    	vendors.forEach(function(e){
			    		if(e.long <= log || e.lat <=lat)
			    			$("#vdata").append('<div class="col-md-6 about_agile about_agileinfo_grid_imgs" style="color: white"><h4>'+e.place_name+'</h4><img src="{{asset("uploads")}}'+'/'+e.photo+'" alt="" /><p>'+(e.place_history).substr(1,100)+'</p><div class="agileits-button two"><a class="btn btn-primary btn-lg scroll" href="{{url("place_view")}}'+"/"+e.pid+'" role="button">Explore »</a></div></div>');
			    });
					...
					<div id="owl-demo2" class="owl-carousel">
						<div class="agile">
							<div class="test-grid">
								...
								<div class="col-md-3 test-grid2">
									<img src="{{asset('m/images/t1.jpg')}}" alt="" class="img-r">
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="agile">
							<div class="test-grid">
								...
								<div class="col-md-3 test-grid2">
									<img src="{{asset('m/images/t2.jpg')}}" alt="" class="img-r">
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="agile">
							<div class="test-grid">
								...
								<div class="col-md-3 test-grid2">
									<img src="{{asset('m/images/t3.jpg')}}" alt="" class="img-r">
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
