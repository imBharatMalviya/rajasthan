	...
	<div class="about" id="welcome">
		<div class="container">
			<div class="wthree_head_section" style="text-align: center;">
				...
				<h3 class="agile_tittle"><p><?php echo e($place->place_desc); ?></p></h3>
			</div>
		</div>
	</div>
	<div class="portfolio-agileinfo" id="portfolio" >
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="agile_tittle"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span><?php echo e($place->place_name); ?></span>Photo Gallery</h3>
			</div>
		</div>
